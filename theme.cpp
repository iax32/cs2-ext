...
namespace overlay {
    ...
    void ApplyMinimalDarkTheme()
    {
        ...
        colors[ImGuiCol_ChildBg] = ImVec4(0.12f, 0.13f, 0.15f, 0.60f);
        colors[ImGuiCol_PopupBg] = ImVec4(0.10f, 0.11f, 0.13f, 0.98f);

        colors[ImGuiCol_Border] = ImVec4(0.24f, 0.26f, 0.30f, 0.80f);
        ...
        colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.35f, 0.39f, 0.45f, 1.00f);
        colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.42f, 0.46f, 0.53f, 1.00f);
        ...
        colors[ImGuiCol_SeparatorHovered] = ImVec4(0.35f, 0.68f, 0.98f, 0.78f);
        colors[ImGuiCol_SeparatorActive] = ImVec4(0.35f, 0.68f, 0.98f, 1.00f);

        colors[ImGuiCol_ResizeGrip] = ImVec4(0.35f, 0.68f, 0.98f, 0.20f);
        colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.35f, 0.68f, 0.98f, 0.67f);
        colors[ImGuiCol_ResizeGripActive] = ImVec4(0.35f, 0.68f, 0.98f, 0.95f);

        colors[ImGuiCol_Tab] = ImVec4(0.14f, 0.16f, 0.19f, 1.00f);
        colors[ImGuiCol_TabHovered] = ImVec4(0.24f, 0.28f, 0.34f, 1.00f);
        colors[ImGuiCol_TabActive] = ImVec4(0.19f, 0.22f, 0.27f, 1.00f);
        ...
        colors[ImGuiCol_PlotHistogram] = ImVec4(0.35f, 0.68f, 0.98f, 1.00f);
        colors[ImGuiCol_PlotHistogramHovered] = ImVec4(0.45f, 0.75f, 1.00f, 1.00f);
        ...
        colors[ImGuiCol_TextSelectedBg] = ImVec4(0.35f, 0.68f, 0.98f, 0.35f);
        colors[ImGuiCol_DragDropTarget] = ImVec4(0.45f, 0.75f, 1.00f, 0.90f);
        colors[ImGuiCol_NavHighlight] = ImVec4(0.35f, 0.68f, 0.98f, 1.00f);
        colors[ImGuiCol_NavWindowingHighlight] = ImVec4(1.00f, 1.00f, 1.00f, 0.70f);
        colors[ImGuiCol_ModalWindowDimBg] = ImVec4(0.05f, 0.06f, 0.08f, 0.73f);
    }
